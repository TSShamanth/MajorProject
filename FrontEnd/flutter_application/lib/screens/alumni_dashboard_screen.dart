...
class _AlumniDashboardScreenState extends State<AlumniDashboardScreen> {
                  ...
                  Expanded(
                    child: TextField(
                      decoration: InputDecoration(
                        hintText: 'Search alumni, jobs, events...',
        ...
        children: [
          Text('Alumni Network Portal',
              style: TextStyle(
                  ...
                  letterSpacing: -0.5)),
          const SizedBox(height: 4),
          Text('Manage alumni connections, jobs, events, and donations',
  ...
  Widget _buildStatsGrid(bool isMobile) {
    final stats = [
      {'title': 'Total Alumni', 'value': '1,250', 'icon': Icons.group_rounded, 'color': _accent},
      {'title': 'New Members (This Year)', 'value': '180', 'icon': Icons.person_add_rounded, 'color': _success},
    ];
