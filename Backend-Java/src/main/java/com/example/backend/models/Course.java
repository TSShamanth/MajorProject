...
public class Course {
    ...
    public Course(String courseCode, String courseName, String facultyUid, String institutionId, String program, String semester, List<String> studentsEnrolled, String totalClasses) {
